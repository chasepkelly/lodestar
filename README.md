...
pip install git+ssh://git@github.com/chasepkelly/lodestar.git
```
...
```sh
# install from the production repo
pip install 'lodestar[aiohttp] @ git+ssh://git@github.com/chasepkelly/lodestar.git'
```
...
These methods return an [`APIResponse`](https://github.com/chasepkelly/lodestar/tree/main/src/lodestar/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/chasepkelly/lodestar/tree/main/src/lodestar/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/chasepkelly/lodestar/issues) with questions, bugs, or suggestions.
