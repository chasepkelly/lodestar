...
from ._exceptions import LodestarError, APIStatusError
...
class Lodestar(SyncAPIClient):
    pet: pet.PetResource
    store: store.StoreResource
    user: user.UserResource
    with_raw_response: LodestarWithRawResponse
    with_streaming_response: LodestarWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Lodestar client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("LODESTAR_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = LodestarWithRawResponse(self)
        self.with_streaming_response = LodestarWithStreamedResponse(self)
...
class AsyncLodestar(AsyncAPIClient):
    pet: pet.AsyncPetResource
    store: store.AsyncStoreResource
    user: user.AsyncUserResource
    with_raw_response: AsyncLodestarWithRawResponse
    with_streaming_response: AsyncLodestarWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncLodestar client instance.
        ...
        self.with_raw_response = AsyncLodestarWithRawResponse(self)
        self.with_streaming_response = AsyncLodestarWithStreamedResponse(self)
...
class LodestarWithRawResponse:
    def __init__(self, client: Lodestar) -> None:
...
class AsyncLodestarWithRawResponse:
    def __init__(self, client: AsyncLodestar) -> None:
...
class LodestarWithStreamedResponse:
    def __init__(self, client: Lodestar) -> None:
...
class AsyncLodestarWithStreamedResponse:
    def __init__(self, client: AsyncLodestar) -> None:
