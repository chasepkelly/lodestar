...
from lodestar import Lodestar, AsyncLodestar, APIResponseValidationError
from lodestar._types import Omit
from lodestar._models import BaseModel, FinalRequestOptions
from lodestar._exceptions import LodestarError, APIStatusError, APITimeoutError, APIResponseValidationError
from lodestar._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Lodestar | AsyncLodestar) -> int:
...
class TestLodestar:
    client = Lodestar(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "lodestar/_legacy_response.py",
                        "lodestar/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LodestarError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = Lodestar(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Lodestar) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Lodestar(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(LODESTAR_BASE_URL="http://localhost:5000/from/env"):
            client = Lodestar(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Lodestar(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Lodestar(
    ...
    def test_base_url_trailing_slash(self, client: Lodestar) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Lodestar) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Lodestar) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Lodestar(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Lodestar(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Lodestar(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("lodestar._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Lodestar) -> None:
    ...
    @mock.patch("lodestar._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Lodestar) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Lodestar, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncLodestar:
    client = AsyncLodestar(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LodestarError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncLodestar(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncLodestar) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(LODESTAR_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncLodestar(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncLodestar) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncLodestar) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncLodestar) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncLodestar(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncLodestar(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncLodestar
    ) -> None:
        respx_mock.get("/store/inventory").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncLodestar, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from lodestar._utils import asyncify
        from lodestar._base_client import get_platform
