...
class OrderResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> OrderResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/chasepkelly/lodestar#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> OrderResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/chasepkelly/lodestar#with_streaming_response
        """
