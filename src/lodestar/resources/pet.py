...
class PetResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> PetResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/lodestar-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> PetResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/lodestar-python#with_streaming_response
        """
